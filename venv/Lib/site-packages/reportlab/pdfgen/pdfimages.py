...
class PDFImage:
    ...
    def _jpg_imagedata(self, imageFile):
        ...
        imagedata.append('BI /W %d /H %d /BPC 8 /CS /%s /F [%s/DCT] ID' % (
    ...
    def drawInlineImage(self, canvas, preserveAspectRatio=False, anchor='sw', anchorAtXY=False, showBoundary=False):
        ...
        x, y, self.width, self.height, scaled = aspectRatioFix(preserveAspectRatio, anchor, self.x, self.y, width,
                                                               height, self.imgwidth, self.imgheight, anchorAtXY)
