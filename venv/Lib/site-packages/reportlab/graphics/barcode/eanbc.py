...
class Ean13BarcodeWidget(PlotArea):
    ...
    width = property(
        lambda self: self.barWidth * (self._nbars - 18 + self._calc_quiet(self.lquiet) + self._calc_quiet(self.rquiet)))
        ...
        for i, c in enumerate(b):
            if c == "1":
                ...
                if lrect and lrect.y == yh:
                    ...
                    lrect = Rect(x, yh, barWidth, barHeight - dh, fillColor=barFillColor, strokeWidth=barStrokeWidth,
