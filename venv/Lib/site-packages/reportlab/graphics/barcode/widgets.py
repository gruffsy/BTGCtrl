...
from reportlab.lib.validators import isInt, isNumber, isColor, isString, isColorOrNone, OneOf, isBoolean, EitherOr, \
    isNumberOrNone
...
BarcodePOSTNET = _BCW('',
                      ...
                      AttrMap(BASE=_BarcodeWidget,
                              ...
                              spaceWidth=AttrMapValue(isNumber,
...
BarcodeUSPS_4State = _BCW('',
                          "USPS_4State",
                          AttrMap(BASE=_BarcodeWidget,
                                  widthSize=AttrMapValue(isNumber,
                                                         '''(float, default 1): the bar width size adjustment between 0 and 1.'''),
                                  heightSize=AttrMapValue(isNumber,
