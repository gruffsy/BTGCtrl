...
class PMCanvas:
    ...
    def _drawTimeResize(self, w, h, bg=None):
        ...
        A = {'ctm': None, 'strokeWidth': None, 'strokeColor': None, 'lineCap': None, 'lineJoin': None,
             'dashArray': None, 'fillColor': None}
        gs = self._gs
    ...
    def saveToFile(self, fn, fmt=None):
        ...
        if fmt == 'TIFF':
            ...
            if tc:
                ...
                im = Image.merge('RGBA',
                                 im.split() + (ImageChops.invert(im.point(T).convert('L').point(255 * [0] + [255])),))
