...
class StyleProperties(PropHolder):
    ...
    _attrMap = AttrMap(
        ...
        strokeOpacity=AttrMapValue(isNumber, desc='level of transparency (alpha) accepts values between 0..1',
                                   advancedUsage=1),
    ...
    def __call__(self, _x, _y, _size, _color):
        ...
        def aLine(x0, y0, x1, y1):
            if candleKind != 'vertical':
                x0, y0 = y0, x0
                x1, y1 = y1, x1
            G(shapes.Line(x0, y0, x1, y1, strokeWidth=strokeWidth, strokeColor=strokeColor,
        ...
        if haveBox:
            ...
            if candleKind != 'vertical':
                x, y, w, h = y, x, h, w
            G(shapes.Rect(x, y, w, h, strokeColor=strokeColor, strokeWidth=strokeWidth, strokeDashArray=strokeDashArray,
