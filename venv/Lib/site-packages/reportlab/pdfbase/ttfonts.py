...
class TTFontParser:
    ...
    def getSubfont(self, subfontIndex):
        ...
        try:
            ...
            raise TTFError('TTC file "%s": bad subfontIndex %s not in [0,%d]' % (
    ...
    def checksumTables(self):
        ...
        for t in self.tables:
            ...
            if xchecksum != checksum:
                raise TTFError('TTF file "%s": invalid checksum %s table: %s (expected %s)' % (
    ...
    def checksumFile(self):
        ...
        if 0xB1B0AFBA != checksum:
            raise TTFError('TTF file "%s": invalid checksum %s (expected 0xB1B0AFBA) len: %d &3: %d' % (
